...
function printCharity(ein, charityName, webURL, address, city, stateOrProvince, postalCode) {
  //console.log(ein);
    ...
    divCardExpander.appendChild(donateButton);
    divCardExpander.appendChild(followButton);
...
function miniMenuSearch() {
    var searchTerm = document.getElementById("menuSearch").value;
